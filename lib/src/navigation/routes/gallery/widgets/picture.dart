...
class GoalImageWidget extends StatelessWidget {
  ...
  GoalImageWidget({required this.task_id,required this.goalImage, required this.borderColor});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Image(image: goalImage,fit: BoxFit.cover,)
      ),
    );
  }
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(appBar: SnapGoalsAppBar(),
        body: Column(
